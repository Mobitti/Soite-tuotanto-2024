	...
	try
	{
		...
		if($_POST['tj_hakusana'] != "") {
			switch($haettavaarvo) 
			{
				...
				case 'reservitausta': $tj_hakuWhere = " AND reservitausta_id IN(SELECT id FROM reservitausta WHERE selite LIKE '%" . $_POST['tj_hakusana'] . "%' OR numero LIKE '%" . $_POST['tj_hakusana'] . "%')"; break; 
